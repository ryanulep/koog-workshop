...
import org.example.project.db.tables.Armors
...
import org.example.project.db.tables.Potions
import org.example.project.db.tables.Products
import org.example.project.db.tables.Scrolls
...
import org.example.project.domain.enums.ArmorSlot
...
private fun shouldSeedAdminDemoData(): Boolean =
    listOf(Characters, Orders, Products, Merchants, Currencies, ShippingMethods)
...
private class AdminDemoDataSeeder(
    ...
    private fun seedOrderHistory(
        ...
        val subOrderId = SubOrders.insertAndGetId {
            ...
            it[SubOrders.createdAt] = scenario.createdAt
            it[SubOrders.updatedAt] = scenario.updatedAt
        }.value
        ...
        scenario.lineItems.forEach { item ->
            OrderItems.insert {
                ...
                it[OrderItems.createdAt] = scenario.createdAt
                it[OrderItems.updatedAt] = scenario.updatedAt
            }
        }
    ...
    private fun addShippingMethodToMerchant(
        ...
        MerchantShippingMethods.insert {
            ...
            it[MerchantShippingMethods.shippingMethod] = shippingMethodSeed.id.value
        }
    }

    context(_: Transaction)
    private fun insertCharacter(name: String): CharacterId = CharacterId(
